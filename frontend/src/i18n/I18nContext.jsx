...
const dictionaries = {
  en: {
    ...
    'pricing.subtitle': 'Pay only for what you use. No subscriptions, no hidden fees.',
    ...
    'pricing.freeDesc': 'Track up to 5 packages at a time with full carrier detection.',
    'pricing.freeFeat1': '5 simultaneous tracking requests',
    'pricing.freeFeat2': '2,400+ carriers worldwide',
    'pricing.freeFeat3': 'Full transit history',
    'pricing.freeFeat4': 'All languages supported',
    'pricing.freeLimit1': 'No WhatsApp/SMS alerts',
    'pricing.freeLimit2': 'No API access',
    'pricing.tokenTitle': 'Token Packs (Pay-As-You-Go)',
    'pricing.tokenDesc': 'Buy credits once, use them anytime. No expiry, no subscription.',
    'pricing.popular': 'Most Popular',
    'pricing.requests': 'tracking requests',
    'pricing.perRequest': '/ request',
    'pricing.buyNow': 'Buy Now',
    'pricing.processing': 'Processing...',
    'pricing.microTitle': 'Premium Features',
    'pricing.microDesc': 'Unlock extra convenience for specific packages.',
    ...
    'pricing.apiTitle': 'API Pay-As-You-Go',
    'pricing.apiDesc': 'Integrate our tracking engine directly into your ERP or e-commerce platform.',
    'pricing.apiFeat1Title': 'API Keys',
    'pricing.apiFeat1Desc': 'Generate keys from your dashboard and connect in minutes.',
    ...
    'pricing.apiFeat4Title': 'Mobile Money',
    'pricing.apiFeat4Desc': 'Pay with Orange Money, MTN MoMo, and local payment methods.',
    'pricing.apiContact': 'Get API Access',
  ...
  fr: {
    ...
    'pricing.subtitle': 'Payez uniquement ce que vous utilisez. Pas d\'abonnement, pas de frais cachés.',
    ...
    'pricing.freeDesc': 'Suivez jusqu\'à 5 colis avec détection automatique du transporteur.',
    'pricing.freeFeat1': '5 suivis simultanés',
    'pricing.freeFeat2': '2 400+ transporteurs mondiaux',
    'pricing.freeFeat3': 'Historique complet du transit',
    'pricing.freeFeat4': 'Toutes les langues supportées',
    'pricing.freeLimit1': 'Pas d\'alertes WhatsApp/SMS',
    'pricing.freeLimit2': 'Pas d\'accès API',
    'pricing.tokenTitle': 'Packs de Jetons (Prépayé)',
    'pricing.tokenDesc': 'Achetez des crédits une fois, utilisez-les quand vous voulez. Sans expiry, sans abonnement.',
    ...
    'pricing.microTitle': 'Fonctionnalités Premium',
    'pricing.microDesc': 'Débloquez plus de confort pour des colis spécifiques.',
    ...
    'pricing.apiTitle': 'API à l\'utilisation',
    'pricing.apiDesc': 'Intégrez notre moteur de suivi directement dans votre ERP ou plateforme e-commerce.',
    'pricing.apiFeat1Title': 'Clés API',
    'pricing.apiFeat1Desc': 'Générez des clés depuis votre tableau de bord.',
    ...
    'pricing.apiFeat4Title': 'Mobile Money',
    'pricing.apiFeat4Desc': 'Payez avec Orange Money, MTN MoMo et paiements locaux.',
    'pricing.apiContact': 'Accéder à l\'API',
  ...
  es: {
    ...
    'pricing.subtitle': 'Paga solo por lo que usas. Sin suscripciones, sin cargos ocultos.',
    ...
    'pricing.freeDesc': 'Rastrea hasta 5 paquetes con detección automática de transportista.',
    'pricing.freeFeat1': '5 seguimientos simultáneos',
    'pricing.freeFeat2': '2.400+ transportistas mundiales',
    'pricing.freeFeat3': 'Historial completo de tránsito',
    'pricing.freeFeat4': 'Todos los idiomas',
    'pricing.freeLimit1': 'Sin alertas WhatsApp/SMS',
    'pricing.freeLimit2': 'Sin acceso API',
    'pricing.tokenTitle': 'Packs de Tokens (Prepago)',
    'pricing.tokenDesc': 'Compra créditos una vez, úsalos cuando quieras. Sin caducidad, sin suscripción.',
    ...
    'pricing.microTitle': 'Funciones Premium',
    'pricing.microDesc': 'Desbloquea más comodidad para paquetes específicos.',
    ...
    'pricing.apiTitle': 'API de Pago por Uso',
    'pricing.apiDesc': 'Integra nuestro motor de seguimiento en tu ERP o plataforma e-commerce.',
    'pricing.apiFeat1Title': 'Claves API',
    'pricing.apiFeat1Desc': 'Genera claves desde tu panel y conéctate en minutos.',
    ...
    'pricing.apiFeat4Title': 'Mobile Money',
    'pricing.apiFeat4Desc': 'Paga con Orange Money, MTN MoMo y métodos locales.',
    'pricing.apiContact': 'Obtener Acceso API',
  ...
  de: {
    ...
    'pricing.subtitle': 'Zahlen Sie nur, was Sie nutzen. Keine Abonnements, keine versteckten Gebühren.',
    ...
    'pricing.freeDesc': 'Verfolgen Sie bis zu 5 Pakete mit automatischer Carrier-Erkennung.',
    'pricing.freeFeat1': '5 gleichzeitige Sendungsverfolgungen',
    'pricing.freeFeat2': '2.400+ Carrier weltweit',
    'pricing.freeFeat3': 'Vollständige Transithistorie',
    'pricing.freeFeat4': 'Alle Sprachen unterstützt',
    'pricing.freeLimit1': 'Keine WhatsApp/SMS-Benachrichtigungen',
    'pricing.freeLimit2': 'Kein API-Zugang',
    'pricing.tokenTitle': 'Token-Pakete (Prepaid)',
    'pricing.tokenDesc': 'Credits einmal kaufen, jederzeit nutzen. Kein Ablauf, kein Abo.',
    ...
    'pricing.microTitle': 'Premium-Funktionen',
    'pricing.microDesc': 'Extra-Komfort für bestimmte Pakete freischalten.',
    ...
    'pricing.apiTitle': 'API Pay-As-You-Go',
    'pricing.apiDesc': 'Integrieren Sie unsere Tracking-Engine direkt in Ihr ERP oder E-Commerce.',
    'pricing.apiFeat1Title': 'API-Schlüssel',
    'pricing.apiFeat1Desc': 'Schlüssel im Dashboard generieren und sofort verbinden.',
    ...
    'pricing.apiFeat4Title': 'Mobile Money',
    'pricing.apiFeat4Desc': 'Mit Orange Money, MTN MoMo und lokalen Zahlungsmethoden bezahlen.',
    'pricing.apiContact': 'API-Zugang anfordern',
