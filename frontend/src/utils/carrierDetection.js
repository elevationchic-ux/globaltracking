...
/** Regional grouping used by the coverage section (USA / Canada / Europe + emerging). */
export const REGION_COVERAGE = [
  ...
  },
  {
    id: 'AFRICA',
    flag: '🌍',
    carriers: ['POSTEC Cameroon', 'NIPOST Nigeria', 'SAPO South Africa', 'Kenya Post', 'Ghana Post', 'DHL Africa'],
  },
  {
    id: 'LATIN_AMERICA',
    flag: '🌎',
    carriers: ['Correos Mexico', 'Correos Argentina', 'ECT Brazil', 'Chilexpress', 'Servientrega'],
  },
  {
    id: 'ASIA_PACIFIC',
    flag: '🌏',
    carriers: ['China Post', 'Japan Post', 'India Post', 'Australia Post', 'Singapore Post', 'Korea Post'],
  },
]
...
export const CARRIERS = [
  ...
  // ── Emerging market carriers (Africa, Latin America, Asia-Pacific) ──
  {
    code: 'postec',
    name: 'POSTEC Cameroon',
    region: REGIONS.AFRICA,
    countries: ['Cameroon'],
    patterns: [/^CM\d{9,12}$/, /^CM[A-Z]\d{8}$/],
    weight: 35,
    sample: 'CM123456789',
  },
  {
  ...
  },
  {
    ...
    name: 'DHL Africa',
    region: REGIONS.AFRICA,
    countries: ['Africa', 'Worldwide'],
    patterns: [],
    weight: 30,
    sample: 'GM12345678901234',
  },
  {
    code: 'correosmx',
    name: 'Correos Mexico',
    region: REGIONS.LATIN_AMERICA,
    countries: ['Mexico'],
    patterns: [/^MX\d{9,12}$/],
    weight: 35,
    sample: 'MX123456789',
